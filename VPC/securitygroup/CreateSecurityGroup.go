...
func main() {
	...
	vpcIdSecurityGroup := COMMON.VpcId
	enterpriseProjectIdSecurityGroup := COMMON.EnterpriseProjectIdVpc
	securityGroupbody := &model.CreateSecurityGroupOption{
		Name:                COMMON.SecurityGroupName,
		VpcId:               &vpcIdSecurityGroup,
		EnterpriseProjectId: &enterpriseProjectIdSecurityGroup,
	}
